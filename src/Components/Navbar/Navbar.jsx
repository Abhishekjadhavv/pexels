  ...
  return (
    <>
       <nav className='navbar flex justify-between'>
          <div className="narbar-logo">
              {/* <img src={pexelLogo1} alt="pexelLogo1" /> */}
              ...
              <svg width="40" height="40" className="DisplayNone_mobile-tablet__6iQd1 spacing_noMargin__Q_PsJ spacing_oversized-margin-right-50__Z6BXP spacing_desktop-margin-right-30__C4NEG spacing_mobile-margin-right-15__uM70E spacing_tablet-margin-right-15__zeT1z" viewBox="0 0 50 50"><g transform="translate(-3894 2762)"><rect width="50" height="50" rx="8" transform="translate(3894 -2762)" fill="#07a081"></rect><path d="M32.671,44.73h7.091V37.935H41.9a5.657,5.657,0,1,0,0-11.314H32.671Zm10.763,3.622H29V23H41.9a9.271,9.271,0,0,1,1.53,18.435Z" transform="translate(3880 -2773)" fill="#fff"></path></g></svg>
          </div>
           <div className='flex gap-1-5'>
           <ul className='right-menu-list flex gap-1-5'>
              <li><NavLink className="right-menu-link">Explore</NavLink></li>
              <li><NavLink className="right-menu-link">License</NavLink></li>
              <li><NavLink className="right-menu-link">Upload</NavLink></li>
              <li>
                <svg width="30" height="30" className="red right-menu-svg" fill="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.48 13.32a1.8 1.8 0 1 1 0-3.6 1.8 1.8 0 0 1 0 3.6Zm6 0a1.8 1.8 0 1 1 0-3.6 1.8 1.8 0 0 1 0 3.6Zm6 0a1.8 1.8 0 1 1 0-3.6 1.8 1.8 0 0 1 0 3.6Z"></path>
                </svg>
             </li>
           </ul> 
           <div className="navbar-btns flex gap-1">
             <NavLink className="join-btn">join</NavLink>
             <svg width="40" height="40" className="red menu-bar" fill="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
